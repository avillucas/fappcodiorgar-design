    ...
    <div className="space-y-12 pb-16">
      ...
      >
        <div className="flex flex-col md:flex-row items-start gap-8">
          {/* Avatar / Symbolic Representation */}
          <div className="w-full md:w-56 flex-shrink-0 flex flex-col items-center text-center p-5 bg-gradient-to-b from-sky-50 to-slate-100 rounded-2xl border border-sky-100">
            <div className="w-28 h-28 rounded-full bg-sky-900 text-amber-200 flex items-center justify-center font-bold text-4xl shadow-inner mb-3 border-4 border-white">
              SC
            </div>
            ...
            <span className="mt-3 text-[11px] bg-sky-200/80 text-sky-950 font-bold px-2.5 py-1 rounded-full">
          ...
          <div className="space-y-4 flex-1">
            <div className="inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-wider text-amber-700 bg-amber-50 px-3 py-1 rounded-full border border-amber-200">
              ...
              <span>Sobre el Presidente de FAPPCODI</span>
            </div>
