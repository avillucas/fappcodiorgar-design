import { JobPosting, ProvinceCUDInfo, PressItem } from '../types';
...
export const INSTITUTIONAL_INFO = {
  ...
  social: {
    ...
    youtube: "https://www.youtube.com/@fappcodi9877"
  }
};
...
export const PRESS_ARTICLES: PressItem[] = [
  {
    id: "la-nacion-silvio-catania-domingo-grimberg",
    title: "Su jefe no lo quería en su equipo por ser ciego pero se volvió una pieza clave",
    media: "LA NACION",
    author: "Lorena Oliva",
    date: "7 de agosto de 2021",
    category: "Entrevista",
    url: "https://www.lanacion.com.ar/comunidad/su-jefe-no-lo-queria-en-su-equipo-por-ser-ciego-hasta-que-pudo-demostrar-que-era-un-gran-empleado-nid07082021/",
    imageUrl: "/images/silvio-catania-domingo-grimberg.jpg",
    linkText: "Leer nota completa en LA NACION",
    excerpt: "Poco después de quedarse ciego, Silvio Catania conoció a Domingo Grimberg, un médico que valoró todo su potencial, le abrió las puertas al mundo del trabajo y lo apoyó a pesar de las resistencias.",
    fullText: "Poco después de quedarse ciego a los 21 años debido a una atrofia del nervio óptico sin explicación médica aparente, Silvio Catania conoció a Domingo Grimberg, un reconocido médico pediatra con cincuenta años de trayectoria y entonces secretario de Salud del municipio de Lanús, quien valoró todo su potencial, le abrió las puertas al mundo del trabajo y lo apoyó a pesar de las resistencias iniciales.\n\nSentado en un rincón, sin hacer nada: así debía quedarse Silvio según los planes de su jefe cuando ingresó en julio de 1998 al área de monitoreo de Defensa Civil. Silvio estaba perfectamente calificado con matrícula de radio operador, pero su ceguera despertaba prejuicios. La designación había sido impulsada por Domingo Grimberg, quien ante las quejas del superior respondió: 'Primero conocelo y después hablamos'.\n\nCon los años, aquel jefe le confesó avergonzado a Silvio lo equivocado que estaba: Silvio memorizaba más de doscientos teléfonos y las calles de Lanús con una precisión envidiable, convirtiéndose en un empleado modelo y muy querido por sus compañeros. 'Primero viene Mingo y después Dios', afirma Silvio. Esa experiencia transformadora inspiró a Silvio a fundar FAPPCODI en el año 2000 para que muchas más personas con discapacidad tengan su oportunidad laboral.",
    highlightQuote: "“Primero conocelo y después hablamos” — Dr. Domingo Grimberg al responder a los prejuicios sobre la contratación de Silvio Catania."
  },
  {
